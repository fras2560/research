...
\end{Observation}
\noindent {\it Proof.} Let $x$ be a vertex from $Z_i$ and $y$ be a vertex from $U \cup W_{i+2} \cup W_{i+3} \cup W_{i+4} \cup Y_{i} \cup Y_{i+1} \cup Y_{i+2} \cup Y_{i+4} \cup X_{i} \cup X_{i+1} \cup X_{i+4}$. If $xy \in \E$ then there is a $K_4$ since $Z_i$ shares two vertices of the $C_5$ with $y$. 
