...
\begin{minipage}{0.5\textwidth}% adapt widths of minipages to your needs
	\noindent {\it Proof.} By Lemmas \ref{lem:yi-cojoins-yi1} and \ref{lem:yi-joins-yi2} $\chi (Y) = 2$ and by Observation \ref{obs:xi-joins-yi} $\omega(G - Y) = \omega(G) - 2$. Since $\omega(G - Y) = \omega(G) - 2 $ and $\chi(Y) = 2$ then by Observation \ref{obs:clique-chi} $\chi(G) = \omega(G)$.
\end{minipage}
\hfill
...
\begin{minipage}{0.5\textwidth}% adapt widths of minipages to your needs
	\noindent {\it Proof.} By Lemmas \ref{lem:yi-cojoins-yi1} and \ref{lem:yi-joins-yi2} $\chi(Y) = 2$. There are Four cases to examine.
	\begin{itemize}
	\item[(i)]
...
\begin{minipage}{0.5\textwidth}% adapt widths of minipages to your needs
	\noindent {\it Proof.} By Lemmas \ref{lem:yi-cojoins-yi1} and \ref{lem:yi-joins-yi2} $\chi(Y) = 1$. There are two cases to examine
	\begin{itemize}
	\item[(i)]
...
\begin{minipage}{0.5\textwidth}% adapt widths of minipages to your needs
	\noindent {\it Proof.} There is only one case to examine since by Observation \ref{obs:xi-joins-yi} $\omega(G - Y) = \omega(G) - 1 $. By Lemmas \ref{lem:yi-cojoins-yi1} and \ref{lem:yi-joins-yi2}  $\chi(Y) = 1$. Since $\omega(G - Y) = \omega(G) - 1$ and $\chi(Y) =1 $ then by Observation \ref{obs:clique-chi} $\chi(G) = \omega(G)$.
\end{minipage}
\hfill
\begin{minipage}{0.5\textwidth}\raggedleft
...
\end{Observation}
\begin{minipage}{0.5\textwidth}% adapt widths of minipages to your needs
	\noindent {\it Proof} Since $|Y| = 1$ then $\chi(Y) = 1$. There are two cases to examine
...
\begin{minipage}{0.5\textwidth}% adapt widths of minipages to your needs
	\noindent {\it Proof} Since $|Y| = 1$ then $\chi(Y) = 1$. There are three cases to examine
	\begin{itemize}
		\item[(i)]
			$|X_{i+1}| \geq |X_i| \geq |X_{i+3}|$
