...
$\phi(N_x) = I$
\end{Observation} 
\noindent {\it Proof.} By Observations \ref{obs:ni-join-1}, \ref{obs:ni-1-neighbor}, and \ref{obs:ni-2-neighbor} $\phi(N_x) \geq I$. Since each $N_i$ is a stable set $\phi(N_x) \leq I$. So by Squeeze Theroem $\phi(N_x) = I$.
