"""
-------------------------------------------------------
A conjecture made that if G is (co-cricket, Even-hole)-free then the following hold:
    1. G is (diamond)-free
    2. G contains a clique cutset
    3. G is a join of one graph to another
-------------------------------------------------------
...
from graph.helper import make_diamond, make_cycle, make_kite, make_wheel, make_co_cricket
...
logging.basicConfig(filename="C7-find_special_graph.log", level=logging.INFO,
